...
class AllBooksAdapter(private val books : List<Book>, private val context: Context) : RecyclerView.Adapter<AllBooksAdapter.BookHolder>() {
    ...
    override fun onBindViewHolder(holder: BookHolder, position: Int) {
        ...
        holder.deleteBook.setOnClickListener {
            ...
            favoritesDB.deleteFavorite(book.isbn)
            context.startActivity(Intent(context, AllBooksActivity::class.java))
        }
    }

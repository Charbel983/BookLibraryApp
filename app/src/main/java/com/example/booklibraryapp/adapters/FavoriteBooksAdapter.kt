...
class FavoriteBooksAdapter(private val favorites : List<FavoriteBook>, private val context: Context) : RecyclerView.Adapter<FavoriteBooksAdapter.FavoriteHolder>() {
    ...
    override fun onBindViewHolder(holder: FavoriteHolder, position: Int) {
        ...
        holder.addToFavorites.setOnClickListener {
            ...
            context.startActivity(Intent(context, FavoriteBooksActivity::class.java))
        }
